...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoApp = __webpack_require__(169);
	...
	ReactDOM.render(React.createElement(TodoApp, { items: TODOS }), document.getElementById("todoListApp"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompletedItemTableList = __webpack_require__(170);
	var TodoItemTableList = __webpack_require__(172);
	var ItemInput = __webpack_require__(174);

	var TodoApp = React.createClass({
	  displayName: 'TodoApp',


	  handleUserInput: function handleUserInput(inputText) {
	    this.setState({
	      inputText: inputText
	    });
	  },
	  ...
	  deleteRowItem: function deleteRowItem(itemId) {
	  ...
	  updateCompletedItems: function updateCompletedItems(itemId) {
	    var itemIndex = this.getItemIndex(itemId);
	  ...
	  getItemIndex: function getItemIndex(itemId) {
	  ...
	  getCompletedItemIndex: function getCompletedItemIndex(itemId) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(TodoItemTableList, {
	        items: this.state.items,
	        deleteRowItem: this.deleteRowItem,
	        updateCompletedItems: this.updateCompletedItems
	      }),
	      React.createElement(CompletedItemTableList, {
	        completedItems: this.state.completedItems
	      })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompletedItemRow = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItemTableRow = __webpack_require__(173);

	var TodoItemTableList = React.createClass({
	  displayName: 'TodoItemTableList',
	  ...
	  render: function render() {
	    ...
	    rows = this.props.items.map(function (item, i) {
	      return React.createElement(TodoItemTableRow, { item: item, i: i, key: i, deleteRowItem: this.deleteRowItem, updateCompletedItems: this.props.updateCompletedItems });
	    }.bind(this));
	    return React.createElement(
	      'table',
	      null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItemTableRow = React.createClass({
	  displayName: 'TodoItemTableRow',


	  deleteRowItem: function deleteRowItem() {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'td',
	        null,
	        React.createElement('input', { type: 'checkbox', checked: this.props.item.completed, onChange: this.onChange })
	      ),
	      React.createElement(
	        'td',
	        null,
	        React.createElement('input', { type: 'button', className: 'removeBtn', value: 'Remove', onClick: this.deleteRowItem })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemInput = React.createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    e.preventDefault();
	    this.props.onUserSubmit({ todoTask: this.refs.inputText.value });
	  },
	  //Method to render the input form
	  render: function render() {
	    return React.createElement(
	      'form',
	      { className: 'itemInputForm', onSubmit: this.handleSubmit },
